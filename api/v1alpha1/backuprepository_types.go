...
type BackupRepositorySpec struct {
	...
	// foo is an example field of BackupRepository. Edit backuprepository_types.go to remove/update
	// +optional
...
type BackupRepositoryStatus struct {
	...
	// conditions represent the current state of the BackupRepository resource.
...
type BackupRepository struct {
	...
	// +optional
	Status BackupRepositoryStatus `json:"status,omitempty,omitzero"`
}
