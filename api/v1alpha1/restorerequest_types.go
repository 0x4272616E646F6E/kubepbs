...
type RestoreRequestStatus struct {
	...
	// conditions represent the current state of the RestoreRequest resource.
...
type RestoreRequest struct {
	...
	// spec defines the desired state of RestoreRequest
	// +required
	Spec RestoreRequestSpec `json:"spec"`

	// status defines the observed state of RestoreRequest
	// +optional
	Status RestoreRequestStatus `json:"status,omitempty,omitzero"`
}
