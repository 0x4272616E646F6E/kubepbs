...
// +kubebuilder:rbac:groups=backup.pbs.k8s.io,resources=backupschedules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.pbs.k8s.io,resources=backupschedules/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=backup.pbs.k8s.io,resources=backupschedules/finalizers,verbs=update
