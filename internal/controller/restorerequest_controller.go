...
// +kubebuilder:rbac:groups=backup.pbs.k8s.io,resources=restorerequests,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.pbs.k8s.io,resources=restorerequests/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=backup.pbs.k8s.io,resources=restorerequests/finalizers,verbs=update
...
func (r *RestoreRequestReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&backupv1alpha1.RestoreRequest{}).
